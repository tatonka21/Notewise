...
## Final AI App Builder Integration
- [x] Connect AI chat to generateApp/generateWebsite mutations
- [x] Display generated apps in AI chat with preview button
- [x] Add "Generated Apps" tab or section in explorer
- [x] Integrate Expo build API for APK generation
- [x] Add download APK functionality
